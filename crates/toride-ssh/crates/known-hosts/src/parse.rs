...
impl KnownHostEntry {
    ...
    pub fn fingerprint(&self) -> Result<toride_ssh_core::Fingerprint> {
...
pub(crate) fn compute_key_fingerprint(
    public_key_b64: &str,
    key_type_str: &str,
) -> Result<toride_ssh_core::Fingerprint> {
